...
def get_data():
    response = requests.get("http://192.168.15.7:5000/serial-data")
...
def dropdown():
        data = get_data()
        return render_template('includes/default.html', symptoms=symptoms, data = data)
...
def get_location():
    ...
    return render_template('location.html',location=location,symptoms=symptoms)
